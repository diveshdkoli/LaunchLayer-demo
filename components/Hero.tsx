...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <canvas ref={particleCanvasRef} className="absolute inset-0 w-full h-full object-cover -z-30 pointer-events-none" />
      ...
      {/* 
        ...
        The Red Planet is now rendered in the global background layer (BackgroundPlanet.tsx)
        and floats dynamically in fixed parallax space behind this section.
      */}
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col gap-8 text-left relative pr-0 lg:pr-8">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 border border-brand-red/20 bg-brand-red/5 rounded-full w-fit backdrop-blur-sm select-none">
            ...
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/80">
              Launch Layer Creative
            </span>
          </div>

          {/* Simple, Confident, Human Headline */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-white leading-[1.08] select-none uppercase">
            LAUNCH YOUR <br />
            BRAND INTO THE <br />
          ...
          <p className="max-w-xl text-[13px] sm:text-[15px] text-white/60 leading-relaxed font-light">
            We design and build bespoke digital experiences, high-performance websites, and cohesive digital systems. No templates. No generic layouts. Just elegant engineering custom-tailored to establish your online presence and launch your brand.
          </p>
        ...
        <div className="lg:col-span-5 flex items-center justify-center lg:justify-end w-full">
          ...
          {/* 
            Glow-framed Accordion Container:
            Positioned prominently on the right side of the hero section, properly scaled,
            highly responsive, floating naturally with an Imperial Night red-glow border shadow.
          */}
      ...
      {/* Down Scroll Prompt */}
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 hidden md:flex flex-col items-center gap-2 text-white/20 cursor-pointer hover:text-brand-red transition-colors z-10" onClick={(e) => handleCTA(e as any, "#services")}>
        <span className="font-mono text-[8px] uppercase tracking-[0.25em]">Explore System</span>
