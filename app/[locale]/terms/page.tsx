...
export default function TermsPage() {
  ...
  return (
    <main className="relative min-h-screen bg-[#000F08] text-white py-20 px-6 sm:py-28 md:px-12 flex items-center justify-center overflow-hidden">
      <div className="absolute left-0 top-1/4 w-[40vw] h-[40vw] rounded-full ambient-glow-red -z-10 opacity-15" />
      <div className="absolute right-0 bottom-0 w-[30vw] h-[30vw] rounded-full ambient-glow-red -z-10 opacity-10" />
